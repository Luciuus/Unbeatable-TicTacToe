...
export default function BackgroundEffects() {
    ...
    useEffect(() => {
        const moveLight = (e: MouseEvent) => {
            ...
            lightRef.current.style.transform = `translate(${e.clientX - 200}px, ${e.clientY - 200}px)`;
        };
    ...
    return (
        <>
            ...
            <div
                ref={lightRef}
                className="pointer-events-none absolute left-0 top-0 h-[400px] w-[400px] rounded-full opacity-0 blur-3xl transition-transform duration-75"
                style={{
